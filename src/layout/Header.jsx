...
function Header() {
  return (
    <header aria-label="header" className="min-w-[414px] max-w-[1280px] mx-8 my-6">
    <div
    ...
    >
      ...
      >
       <Link to="/contact"> <FontAwesomeIcon
          icon={faUser}
    ...
    <nav className="flex flex-col text-center gap-10 text-5xl leading-10 pt-14 sm:flex-row sm:text-sm sm:font-bold sm:pt-8 sm:gap-5">
