    ...
    <footer className="w-full flex flex-col justify-center items-center">
      ...
      >
        <div
          ...
          className="text-left flex flex-col gap-6 sm:min-w-60"
        >
          <h3>Get In Touch</h3>
          <p className="max-w-52 text-txt-g">
            the quick fox jumps over the lazy dog
          </p>
          <div aria-label="social-icons" className="flex gap-4 text-c1">
        ...
        <div
          ...
          className="text-left flex flex-col gap-5 sm:min-w-60"
        >
          <h3>Company info</h3>
      ...
      <div
        ...
        className="flex w-full flex-col items-center bg-[#FAFAFA]"
      >
        <span className="max-w-56 sm:max-w-full py-6 text-center text-sm font-bold tracking-[0.2px]">
          Made with ❤️ by Dotu. All Right Reserved &copy; {getYear()}
        </span>
      </div>
    </footer>
  );
